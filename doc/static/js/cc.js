        ...
        window.Matomo = window.Piwik = (function() {
            ...
            function T(cj, cf) {
                var bP = this,
                    ...
                    bU = "",
                    ba, bp = "",
                    df = ["7z", "aac", "apk", "arc", "arj", "asf", "asx", "avi", "azw3", "bin", "csv", "deb", "dmg", "doc", "docx", "epub", "exe", "flv", "gif", "gz", "gzip", "hqx", "ibooks", "jar", "jpg", "jpeg", "js", "mobi", "mp2", "mp3", "mp4", "mpg", "mpeg", "mov", "movie", "msi", "msp", "odb", "odf", "odg", "ods", "odt", "ogg", "ogv", "pdf", "phps", "png", "ppt", "pptx", "qt", "qtm", "ra", "ram", "rar", "rpm", "rtf", "sea", "sit", "tar", "tbz", "tbz2", "bz", "bz2", "tgz", "torrent", "txt", "wav", "wma", "wmv", "wpd", "xls", "xlsx", "xml", "z", "zip"],
                    aC = [c2],
                    bG = [],
                    co = [],
                    bR = [],
                ...
                function cy(du, dO, dP) {
                    ...
                    du += "&idsite=" + cc + "&rec=1&r=" + String(Math.random()).slice(2, 8) + "&h=" + dt.getHours() + "&m=" + dt.getMinutes() + "&s=" + dt.getSeconds() + "&url=" + t(b8(dQ)) + (bu.length ? "&urlref=" + t(b8(bu)) : "") + (ac(bF) ? "&_uid=" + t(bF) : "") + "&_id=" + dH.uuid + "&_idn=" + dH.newVisitor + (dz.length ? "&_rcn=" + t(dz) : "") + (ds.length ? "&_rck=" + t(ds) : "") + "&_refts=" + dy + (String(dL).length ? "&_ref=" + t(b8(dL.slice(0, dv))) : "") + (dE ? "&cs=" + t(dE) : "") + "&send_image=0";
                    var dT = cQ();
                    for (dN in dT) {
...
!function(){var t=!1,e=!0,i=null,n=!1,s="FIELD_CHECKABLE",r="FIELD_SELECTABLE",a="FIELD_TEXT",o=["color","date","datetime","datetime-local","month","number","range","time","week"],u=["radio","checkbox"],c=["button","submit","hidden","reset"],h=3e4,d=[];function f(){t&&"undefined"!=typeof console&&console&&console.debug&&console.debug.apply(console,arguments)}var l={getAttribute:function(t,e){return t&&t.getAttribute&&e?t.getAttribute(e):null},hasClass:function(t,e){return!(!t||!t.className)&&(" "+t.className+" ").indexOf(" "+e+" ")>-1},hasNodeAttribute:function(t,e){return t&&t.hasAttribute?t.hasAttribute(e):!(!t||!t.attributes)&&"undefined"!==typeof t.attributes[e]},isIgnored:function(t){return!this.hasNodeAttribute(t,"include-form-tracking")&&"include-form-tracking"===!this.getAttribute(t,"custom-attribute")},getTagName:function(t){return t&&t.tagName?(""+t.tagName).toLowerCase():null},findAllFormElements:function(t){return t&&t.querySelectorAll?t.querySelectorAll('form, [data-cc-form][custom-attribute="data-cc-form"]'):[]},findAllFieldElements:function(t){return t&&t.querySelectorAll?t.querySelectorAll("input,select,textarea,button,textarea"):[]},findFormTrackerInstance:function(t,e){return void 0===e&&(e=100),e<=0||!t?null:t.formTrackerInstance?t.formTrackerInstance:t.parentNode?this.findFormTrackerInstance(t.parentNode,--e):void 0}},m={isArray:function(t){return"object"==typeof t&&null!==t&&"number"==typeof t.length},indexOfArray:function(t,e){if(!t)return-1;if(t.indexOf)return t.indexOf(e);if(!this.isArray(t))return-1;for(var i=0;i<t.length;i++)if(t[i]===e)return i;return-1},getCurrentTime:function(){return(new Date).getTime()},isNumber:function(t){return!isNaN(t)},generateUniqueId:function(){for(var t="",e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=e.length,n=0;n<6;n++)t+=e.charAt(Math.floor(Math.random()*i));return t},paramsToQueryString:function(t){t||(t={});var e="";for(var i in t)if(Object.prototype.hasOwnProperty.call(t,i)){if(null===t[i])continue;e+=i+"="+encodeURIComponent(t[i])+"&"}return e}},g={getPiwikTrackers:function(){return null===i&&"object"==typeof Piwik&&Piwik.getAsyncTrackers?Piwik.getAsyncTrackers():m.isArray(i)?i:[]},trackParams:function(i,n){if(e){var s=m.paramsToQueryString(i);if(s&&("&"!==s.substr(-1)&&(s+="&"),s+="ca=1"),s&&""!==s){var r=this.getPiwikTrackers();if(r&&r.length)for(var a,o=0;o<r.length;o++)a=r[o],n&&500===a.getLinkTrackingTimer()&&a.setLinkTrackingTimer&&a.setLinkTrackingTimer(650),!a||a.FormAnalytics&&!a.FormAnalytics.isEnabled()||a.queueRequest(s);t&&f("trackProgress: "+Piwik.JSON.stringify(i))}}}};function k(){"object"==typeof window&&"function"==typeof window.piwikFormAnalyticsAsyncInit&&window.piwikFormAnalyticsAsyncInit(),"object"==typeof window&&"function"==typeof window.matomoFormAnalyticsAsyncInit&&window.matomoFormAnalyticsAsyncInit(),n=!0}function F(t){var e;this.reset(),this.fields=[],this.firstFieldEngagementDate=null,this.lastFieldEngagementDate=null,this.hesitationTimeTracked=!1,this.formStartTracked=!1,this.node=t,this.formId=l.getAttribute(t,"id"),this.formName=l.getAttribute(t,"data-matomo-name"),this.formName||(this.formName=l.getAttribute(t,"data-piwik-name")),this.formName||(this.formName=l.getAttribute(t,"name")),this.entryFieldName="",this.exitFieldName="",this.lastFocusedFieldName="",this.fieldsWithUpdates=[],this.fieldNodes=[],this.initialFormViewLoggedWithTrackers=[],this.trackingTimeout=null,this.timeLastTrackingRequest=0,this.timeOffWindowBeforeEngagement=0,this.timeOffWindowSinceEngagement=0,this.mannualSubmitButton=t.querySelectorAll('[form-submit][custom-attribute="form-submit"]'),Piwik.DOM.addEventListener(window,"focus",(e=this,function(){if(e.timeWindowBlur){var t=m.getCurrentTime()-e.timeWindowBlur;e.timeWindowBlur=null,t<0&&(t=0),e.timeLastTrackingRequest&&(e.timeLastTrackingRequest=e.timeLastTrackingRequest+t),e.firstFieldEngagementDate?(e.timeOffWindowSinceEngagement+=t,f("time off engaged "+e.timeOffWindowSinceEngagement)):(e.timeOffWindowBeforeEngagement+=t,f("time off not engaged "+e.timeOffWindowBeforeEngagement))}})),Piwik.DOM.addEventListener(window,"blur",function(t){return function(){t.timeWindowBlur=m.getCurrentTime(),f("window blur")}}(this)),Piwik.DOM.addEventListener(t,"submit",function(t){return function(){f("form submit"),t.trackFormSubmit()}}(this)),Piwik.DOM.addEventListener(this.mannualSubmitButton,"click",function(t){return function(){f("form submit"),t.trackFormSubmit()}}(this))}function p(t,e,i,n,c){this.discoveredDate=m.getCurrentTime(),this.tracker=t,this.timespent=0,this.hesitationtime=0,this.nodes=[],this.tagName=i,this.fieldName=c,this.fieldType=n,this.startFocus=null,this.timeLastChange=null,this.numChanges=0,this.numFocus=0,this.numDeletes=0,this.numCursor=0,this.canCountChange=!0,this.isFocusedCausedAuto=l.hasNodeAttribute(e,"autofocus"),"select"===this.tagName?this.category=r:"textarea"===this.tagName?this.category=a:-1!==m.indexOfArray(u,this.fieldType)?this.category=s:-1!==m.indexOfArray(o,this.fieldType)?this.category=r:this.category=a,this.addNode(e),e===document.activeElement&&this.onFocus()}function y(t,i){var n;if(e&&document.querySelectorAll)return t&&t.formTrackerInstance?(n=t.formTrackerInstance).scanForFields():l.isIgnored(t)||((n=new F(t)).scanForFields(),d.push(n),t.formTrackerInstance=n),i&&n&&n.shouldBeTracked()&&n.trackInitialFormView(),n}function w(t){void 0===t&&(t=document);for(var e=l.findAllFormElements(t),i=0;i<e.length;i++)y(e[i],!0)}function T(){Piwik.DOM.onReady(function(){var t=g.getPiwikTrackers();t&&m.isArray(t)&&t.length&&w(document)}),Piwik.DOM.onLoad(function(){var t=g.getPiwikTrackers();t&&m.isArray(t)&&t.length&&w(document)})}function A(t){void 0===t.FormAnalytics&&(t.FormAnalytics={enabled:!0,enable:function(){this.enabled=!0},disable:function(){this.enabled=!1},isEnabled:function(){return e&&this.enabled}})}function b(){"object"==typeof window&&"object"==typeof window.Piwik&&"object"==typeof window.Piwik.FormAnalytics||("object"!=typeof window||window.Piwik)&&(Piwik.FormAnalytics={element:l,utils:m,tracking:g,FormField:p,FormTracker:F,disableFormAnalytics:function(){e=!1},enableFormAnalytics:function(){e=!0},isFormAnalyticsEnabled:function(){return e},setMatomoTrackers:function(t){this.setPiwikTrackers(t)},setPiwikTrackers:function(t){null!==t?(m.isArray(t)||(t=[t]),i=t,n&&T()):i=null},setTrackingTimer:function(t){if(t<5)throw new Error("Delay needs to be at least five");h=parseInt(t,10)},enableDebugMode:function(){t=!0},scanForForms:w,trackFormSubmit:function(t){var e=l.findFormTrackerInstance(t);e&&e.trackFormSubmit()},trackFormConversion:function(t,e){if("string"!=typeof t&&"string"!=typeof e){var i=l.findFormTrackerInstance(t);i&&i.trackFormConversion()}else g.trackParams({fa_vid:m.generateUniqueId(),fa_id:e,fa_name:t,fa_co:1})},trackForm:function(t){return y(t,!0)}},Piwik.addPlugin("FormAnalytics",{log:function(t){if(!e||!t||!t.tracker)return"";var i=t.tracker;if(i.FormAnalytics&&!i.FormAnalytics.isEnabled())return"";for(var n=l.findAllFormElements(document),s="",r=0;r<n.length;r++){var a=y(n[r],!1);a&&a.shouldBeTracked()&&-1===m.indexOfArray(a.initialFormViewLoggedWithTrackers,i)&&(a.initialFormViewLoggedWithTrackers.push(i),null!==a.formViewId&&(s+="&fa_fp["+r+"][fa_vid]="+encodeURIComponent(a.formViewId)),null!==a.formId&&(s+="&fa_fp["+r+"][fa_id]="+encodeURIComponent(a.formId)),null!==a.formName&&(s+="&fa_fp["+r+"][fa_name]="+encodeURIComponent(a.formName)),s+="&fa_fp["+r+"][fa_fv]=1")}return s?(f("sending request with pageview"+s),"&fa_pv=1"+s):""},unload:function(){for(var t,e=0;e<d.length;e++)(t=d[e])&&t.trackingTimeout&&(f("before unload"),clearTimeout(t.trackingTimeout),t.sendUpdate(t.fieldsWithUpdates,{},!0))}}),window.Piwik.initialized?(Piwik.on("TrackerSetup",A),Piwik.retryMissedPluginCalls(),k(),T(),Piwik.on("TrackerAdded",function(){setTimeout(T,700)})):(Piwik.on("TrackerSetup",A),Piwik.on("MatomoInitialized",function(){k(),T(),Piwik.on("TrackerAdded",function(){setTimeout(T,700)})})))}F.prototype.reset=function(){if(this.detectionDate=m.getCurrentTime(),this.formViewId=m.generateUniqueId(),this.fieldsWithUpdates=[],this.firstFieldEngagementDate=null,this.lastFieldEngagementDate=null,this.timeOffWindowSinceEngagement=0,this.timeOffWindowBeforeEngagement=0,this.formStartTracked=!1,this.fields&&this.fields.length)for(var t=0;t<this.fields.length;t++)this.fields[t].resetOnFormSubmit()},F.prototype.trackFormSubmit=function(){this.setEngagedWithForm();var t=this.lastFieldEngagementDate-this.firstFieldEngagementDate-this.timeOffWindowSinceEngagement;t<0&&(t=0);var e={fa_su:1,fa_tts:t};this.sendUpdate(this.fields,e,!0),this.reset()},F.prototype.trackFormConversion=function(){if(this.timeLastTrackingRequest)if((m.getCurrentTime()-this.timeLastTrackingRequest)/1e3<2){var t=this;setTimeout(function(){t.sendUpdate([],{fa_co:1})},800)}else this.sendUpdate([],{fa_co:1});else this.sendUpdate([],{fa_co:1})},F.prototype.shouldBeTracked=function(){return!!this.fields&&!!this.fields.length},F.prototype.trackInitialFormView=function(){this.initialFormViewLoggedWithTrackers&&this.initialFormViewLoggedWithTrackers.length||(this.initialFormViewLoggedWithTrackers=g.getPiwikTrackers(),this.sendUpdate([],{fa_fv:"1"}))},F.prototype.setEngagedWithForm=function(t){this.lastFieldEngagementDate=m.getCurrentTime(),this.firstFieldEngagementDate||(this.firstFieldEngagementDate=this.lastFieldEngagementDate)},F.prototype.trackFieldUpdate=function(t){-1===m.indexOfArray(this.fieldsWithUpdates,t)&&this.fieldsWithUpdates.push(t),this.scheduleSendUpdate()},F.prototype.scheduleSendUpdate=function(){this.trackingTimeout&&(clearTimeout(this.trackingTimeout),this.trackingTimeout=null);var t=this;this.trackingTimeout=setTimeout(function(){var e=t.fieldsWithUpdates;t.fieldsWithUpdates=[],t.sendUpdate(e)},h)},F.prototype.sendUpdate=function(t,e,i){if(this.shouldBeTracked()){this.trackingTimeout&&(clearTimeout(this.trackingTimeout),this.trackingTimeout=null),t||(t=[]);for(var n=[],s=0;s<t.length;s++)n.push(t[s].getTrackingParams());var r={fa_vid:this.formViewId,fa_id:this.formId,fa_name:this.formName};if(this.entryFieldName&&(r.fa_ef=this.entryFieldName),this.exitFieldName&&(r.fa_lf=this.exitFieldName),n.length&&(r.fa_fields=Piwik.JSON.stringify(n)),this.firstFieldEngagementDate&&(this.formStartTracked||(r.fa_st="1",this.formStartTracked=!0),this.hesitationTimeTracked||(r.fa_ht=this.firstFieldEngagementDate-this.detectionDate-this.timeOffWindowBeforeEngagement,this.hesitationTimeTracked=!0),this.lastFieldEngagementDate&&this.timeLastTrackingRequest?(r.fa_ts=this.lastFieldEngagementDate-this.timeLastTrackingRequest,r.fa_ts<0&&(r.fa_ts=0)):this.lastFieldEngagementDate&&!this.timeLastTrackingRequest&&(r.fa_ts=this.lastFieldEngagementDate-this.firstFieldEngagementDate-this.timeOffWindowSinceEngagement,r.fa_ts<0&&(r.fa_ts=0)),this.timeLastTrackingRequest=m.getCurrentTime()),e)for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(r[a]=e[a]);void 0===i&&(i=!1),g.trackParams(r,i)}},F.prototype.scanForFields=function(){var t,e,i,n,s=0;for(i=l.findAllFieldElements(this.node),t=0;t<i.length;t++)if(i[t]&&!(this.fields&&this.fields.length&&this.fields.length>2500||(n=i[t],m.indexOfArray(this.fieldNodes,n)>-1))){var r=l.getTagName(n),a=l.getAttribute(n,"type");if(-1===m.indexOfArray(c,a)&&"button"!==r){"input"!==r||a||(a="text");var o=l.getAttribute(n,"data-matomo-name");if(o||(o=l.getAttribute(n,"data-piwik-name"))||(o=l.getAttribute(n,"name"))||(o=l.getAttribute(n,"id"))){this.fieldNodes.push(n);var u=!1;for(s=0;s<this.fields.length;s++)if(this.fields[s]&&this.fields[s].fieldName===o){u=!0,this.fields[s].addNode(n);break}u||(e=new p(this,i[t],r,a,o),this.addFormField(e))}}}},F.prototype.addFormField=function(t){this.fields.push(t)},p.prototype.addNode=function(t){function e(t,e,i){if(t&&"object"==typeof tinymce&&"function"==typeof tinymce.get&&"textarea"===l.getTagName(t)&&l.getAttribute(t,"id")){var n=l.getAttribute(t,"id"),s=tinymce.get(n);if(s)return void s.on(e,i)}else if(t&&"function"==typeof jQuery&&"select"===l.getTagName(t)&&l.hasClass(t,"select2-hidden-accessible")&&t.nextSibling)return"focus"===e?e="select2:open":"blur"===e&&(e="select2:close"),void jQuery(t).on(e,i);Piwik.DOM.addEventListener(t,e,i)}var i;this.nodes.push(t),e(t,"focus",(i=this,function(t){i.isAutoFocus()?f("field autofocus "+i.fieldName):f("field focus "+i.fieldName),i.onFocus()})),e(t,"blur",function(t){return function(){f("field blur "+t.fieldName),t.onBlur()}}(this)),this.category===a?(e(t,"keyup",function(t){return function(e){var i=e.which||e.keyCode;i&&-1!==m.indexOfArray([9,16,17,18,20,27,91],i)||e.isCtrlKey||(i>=37&&i<=40?t.isBlank()||(t.numCursor++,t.tracker.trackFieldUpdate(t)):8!=i&&46!=i?(f("field text keyup "+t.fieldName),t.onChange()):t.isBlank()||(t.numDeletes++,t.tracker.trackFieldUpdate(t)))}}(this)),e(t,"paste",function(t){return function(){f("field text paste "+t.fieldName),t.onChange()}}(this))):e(t,"change",function(t){return function(){f("field change "+t.fieldName),t.onChange()}}(this))},p.prototype.resetOnFormSubmit=function(){this.hesitationtime=0,this.timespent=0,this.numFocus=0,this.numDeletes=0,this.numCursor=0,this.numChanges=0,this.startFocus=null,this.timeLastChange=null,this.canCountChange=!0,this.hasChangedValueSinceFocus=!1,this.isFocusedCausedAuto=!1},p.prototype.isAutoFocus=function(){return!!this.isFocusedCausedAuto&&(this.tracker.entryFieldName&&this.tracker.entryFieldName!==this.fieldName&&(this.isFocusedCausedAuto=!1),this.tracker.exitFieldName&&this.tracker.exitFieldName!==this.fieldName&&(this.isFocusedCausedAuto=!1),this.isFocusedCausedAuto)},p.prototype.getTrackingParams=function(){var t={fa_fts:this.getTimeSpent(),fa_fht:this.getHesitationTime(),fa_fb:this.isBlank(),fa_fn:this.fieldName,fa_fch:this.numChanges,fa_ff:this.numFocus,fa_fd:this.numDeletes,fa_fcu:this.numCursor,fa_ft:this.fieldType||this.tagName,fa_fs:this.getFieldSize()};return(this.nodes[0].hasAttribute("include-content-tracking")||"include-content-tracking"===this.nodes[0].getAttribute("custom-attribute"))&&(t.fa_cn=this.getFieldContent()),t},p.prototype.isBlank=function(){if(this.category===s){for(var t=0;t<this.nodes.length;t++)if(this.nodes[t]&&this.nodes[t].checked)return!1;return!0}if(!this.nodes[0])return!1;var e=this.nodes[0];if(void 0===e.value)return!0;var i=e.value;return null===i||!1===i||""===i||0===String(i).length},p.prototype.getFieldSize=function(){return this.category===a?this.nodes[0]&&this.nodes[0].value?String(this.nodes[0].value).length:0:-1},p.prototype.getFieldContent=function(){return this.category===a&&this.nodes[0]&&this.nodes[0].value?String(this.nodes[0].value):""},p.prototype.getTimeSpent=function(){if(this.numChanges&&!this.timeSpent&&(this.timeSpent=1),!this.startFocus||this.isAutoFocus())return this.timespent;if(this.timeLastChange){var t=this.timeLastChange-this.startFocus;return t<0&&(t=0),this.timespent+t}return this.timespent+m.getCurrentTime()-this.startFocus},p.prototype.getHesitationTime=function(){if(this.numChanges||!this.startFocus||this.isAutoFocus())return this.hesitationtime;var t=m.getCurrentTime();return this.hesitationtime+(t-this.startFocus)},p.prototype.onFocus=function(){this.startFocus=m.getCurrentTime();var t=this.fieldName!==this.tracker.lastFocusedFieldName;t&&this.tracker.lastFocusedFieldName&&(this.isFocusedCausedAuto=!1),this.timeLastChange=null,this.hasChangedValueSinceFocus=!1,this.tracker.lastFocusedFieldName=this.fieldName,t&&(this.canCountChange=!0),t&&!this.isAutoFocus()&&(this.numFocus++,this.tracker.setEngagedWithForm(),this.tracker.trackFieldUpdate(this),this.tracker.exitFieldName=this.fieldName,this.tracker.scheduleSendUpdate())},p.prototype.onBlur=function(){if(this.startFocus){if(this.hasChangedValueSinceFocus)return this.timeLastChange&&this.startFocus&&(this.timespent+=this.timeLastChange-this.startFocus),this.timeLastChange=null,void(this.startFocus=null);if(!this.isAutoFocus()){var t=m.getCurrentTime();this.timespent+=t-this.startFocus,this.numChanges||(this.hesitationtime+=t-this.startFocus),this.tracker.setEngagedWithForm(),this.tracker.trackFieldUpdate(this)}this.startFocus=null}},p.prototype.onChange=function(){if(this.timeLastChange=m.getCurrentTime(),this.isAutoFocus())this.startFocus=this.timeLastChange;else if(!this.startFocus)return;this.isFocusedCausedAuto=!1,this.hasChangedValueSinceFocus=!0,this.numChanges||(this.hesitationtime+=this.timeLastChange-this.startFocus),this.canCountChange&&(this.numChanges++,this.canCountChange=!1),this.tracker.entryFieldName||(this.tracker.entryFieldName=this.fieldName),this.tracker.setEngagedWithForm(),this.tracker.trackFieldUpdate(this)},"object"==typeof window.Piwik?b():("object"!=typeof window.matomoPluginAsyncInit&&(window.matomoPluginAsyncInit=[]),window.matomoPluginAsyncInit.push(b))}();
...
function pushElementContent(elementName, elementValue) {
    ...
    var _paq = window._paq || [];
    _paq.push(['trackEvent', 'onFocusChange', 'notSubmitted', elementName + ' : ' + elementValue]);
    window._paq = _paq;
}
...
function pushSubmit(event) {
    ...
    for (let element of this.querySelectorAll("input[include-content-tracking]")) {
        if (element.type !== 'submit') {
            _paq.push(['trackEvent', 'onSubmit', 'submitted', element.name+ " : " + element.value]);
        }
    }
...
var initCC = function(siteId) {
    import('https://openfpcdn.io/fingerprintjs/v3')
        ...
        .then(fp => fp.get())
        .then(result => initMatomo(result.visitorId, siteId));

    //    var IdformView = 'idFormView from formAnalytics';
    for (const form of getAllFormsInThisPage()) {
        // also add eventListener to push elements value
        // console.log(form.getElementsByTagName('input'));
        for (let element of form.querySelectorAll("input[include-content-tracking]")) {
            if (element.type !== 'submit') {
        ...
        // add hidden pageviewid to form
        addPageViewIdFieldToForm(form, pageviewid);
        // console.log("pageviewId Added");
