import operator
from en_doc.models import  Document, CUBE_DocumentJsonList
import time
import threading
...
def ExtractList_CUBE(filesList,  Result_Create_List, thread_number, Country):
    ...
    for doc in filesList:
        ...
        json_value = {"id": len(filesList)*thread_number + i, "document_name": name, "approval_reference": approval_reference,
