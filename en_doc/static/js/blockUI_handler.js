...
function startBlockUI(container_id) {
  ...
  $(container_selector).block({
    ...
    message:
      "<div class='lds-ellipsis'><div></div><div></div><div></div><div></div></div><h6 dir='ltr' style = 'font-family:vazir;'>Loading information ...<h6>",
    css: {
...
function startFullPageBlockUI() {
  ...
  $.blockUI({
    // BlockUI code for element blocking
    message:
      "<div class='lds-ellipsis'><div></div><div></div><div></div><div></div></div><h6 style = 'font-family:vazir;'>Loading information ...<h6>",
